...
final class FileProviderAnchorDeltaTests: XCTestCase {
    private func item(id: String, hash: String) throws -> WriteItem {
    ...
    func testStoredAnchorProducesOnlyPreciseUpdateAndDeleteDelta() throws {
        ...
        let container = WriteItemIdentifier.folder(handle: "demo", id: "notes")
        ...
        let delta = WriteContainerDelta.compute(previous: stored, current: after)
