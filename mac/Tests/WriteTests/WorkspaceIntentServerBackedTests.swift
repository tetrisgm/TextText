...
final class WorkspaceIntentServerBackedTests: XCTestCase {
    func testManifestDecodesCanonicalURL() throws {
        let data = Data("""
        {
          ...
          "hash":"hash-1",
          "id":"post-1",
          "canonicalUrl":"https://write.example/t/demo/hello"
        }
        """.utf8)
        ...
        XCTAssertEqual(
            item.canonicalUrl, "https://write.example/t/demo/hello")
    }
    ...
    func testManifestMappingUsesPublicCanonicalURLNotSyncTransportURL() throws {
        ...
        XCTAssertEqual(mapped.canonicalURL, URL(string: "https://write.example/t/demo/hello"))
    }
