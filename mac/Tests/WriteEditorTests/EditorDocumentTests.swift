...
final class EditorDocumentTests: XCTestCase {
    ...
    func testEditorFollowsSyncEngineRename() throws {
        ...
        let identified = """
        ---
        writeId: "11111111-2222-3333-4444-555555555555"
        writeFolderId: "notes"
        writeKind: "note"
        title: "Renamed"
        status: "draft"
    ...
    func testIdentityInjectionWhileDirtyMergesInsteadOfConflicting() throws {
        ...
        let injected = "---\n"
            + "writeId: \"99999999-8888-7777-6666-555555555555\"\n"
            + "writeFolderId: \"notes\"\n"
            + "writeKind: \"note\"\n"
            + "title: \"Identity\"\n"
            + "status: \"draft\"\n"
        ...
        try document.save()
        let saved = try readText(url, root: root)
        XCTAssertTrue(saved.contains("writeId: \"99999999-8888-7777-6666-555555555555\""))
    ...
    private func temporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("WriteEditorTests-\(UUID().uuidString)", isDirectory: true)
