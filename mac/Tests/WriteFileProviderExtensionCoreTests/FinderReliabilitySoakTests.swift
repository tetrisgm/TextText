...
private final class FinderSoakAPI: WriteSyncAPI, @unchecked Sendable {
    ...
    private let workspaceValue = WriteWorkspace(
    ...
    func changes(
        ...
        withLock {
            ...
            return .success(WriteChangeReply(
                cursor: current,
