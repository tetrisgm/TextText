...
final class WorkspaceEnumeratorTests: XCTestCase {
    ...
    private func F(_ id: String) -> TextTextItemIdentifier { .folder(handle: "demo", id: id) }
    private func FI(_ id: String) -> TextTextItemIdentifier { .file(handle: "demo", id: id) }
    private func enumr(_ api: TextTextSyncAPI, readOnly: Bool = true) -> WorkspaceEnumerator {
    ...
    func testVirtualContainersAreNotReturnedAsRootItems() async {
        ...
        for identifier in [
            TextTextItemIdentifier.workingSet,
            TextTextItemIdentifier.trashContainer,
        ] {
