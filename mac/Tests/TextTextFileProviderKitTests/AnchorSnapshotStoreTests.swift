...
final class AnchorSnapshotStoreTests: XCTestCase {
    private func item(
        ...
        TextTextItemMapper.item(
            for: TextTextManifestItem(
                ...
                url: "https://texttext.example/item/\(id)"),
    ...
    func testDeltaComputesUpdatedCreatedAndDeleted() {
        ...
        let delta = TextTextContainerDelta.compute(
            previous: TextTextContainerDelta.snapshot(of: before), current: after)
    ...
    func testDeltaIsEmptyWhenNothingChanged() {
        ...
        let delta = TextTextContainerDelta.compute(
            previous: TextTextContainerDelta.snapshot(of: items), current: items)
    ...
    func testStoreRoundTripsOnlyForTheMatchingAnchor() throws {
        ...
        let container = TextTextItemIdentifier.folder(handle: "demo", id: "blog")
        let items = [item(id: "a"), item(id: "b", title: "B")]
        ...
        XCTAssertEqual(
            ...
            TextTextContainerDelta.snapshot(of: items))
    ...
    func testFingerprintUnchangedByCanonicalEncodingRefactor() {
        ...
        XCTAssertEqual(
            ...
            TextTextStableDigest.sha256(canonical))
    }
}
