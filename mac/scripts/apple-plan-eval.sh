...
check "health.runtime" "Reliability: installed app runs content-blind production self-tests" \
  "grep -q 'selftest.filename_codec' '$MAC/Sources/Write/AppHealthReporter.swift' && grep -q 'selftest.document_assets' '$MAC/Sources/Write/AppHealthReporter.swift' && grep -q 'selftest.document_projection' '$MAC/Sources/Write/AppHealthReporter.swift' && grep -q 'workflow.document_engine' '$MAC/Sources/Write/AppHealthReporter.swift' && grep -q 'workflow.collaboration' '$MAC/Sources/Write/AppHealthReporter.swift' && grep -q 'workflow.folder_trash_restore' '$MAC/Sources/Write/AppHealthReporter.swift'"
