...
public enum WorkspaceLayout {
    public static let metadataDirectoryName = ".write"
    public static let localMetadataDirectoryName = ".write-local.nosync"
    ...
    private static func writeWorkspaceMetadata(
        ...
        lines.append("")
        let url = root.appendingPathComponent(".write/workspace.yaml")
