...
public enum CapabilityGeneratorRenderer {
    ...
    public static func renderOutputs(
        ...
        [
            GeneratedCapabilityFile(
                relativePath: "mac/Sources/WriteAppIntents/Generated/CapabilityIdentifiers.swift",
                contents: renderIdentifiers(manifest: manifest, command: command)
            ),
            GeneratedCapabilityFile(
                relativePath: "mac/Sources/WriteAppIntents/Generated/CapabilityCatalog.swift",
            ...
            GeneratedCapabilityFile(
                relativePath: "mac/Tests/WriteAppIntentsTests/GeneratedCapabilityTests.swift",
    ...
    public static func renderGeneratedTests(manifest: CapabilityManifest, command: String) -> String {
        ...
        lines.append("@testable import WriteAppIntents")
        lines.append("")
