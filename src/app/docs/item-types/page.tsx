      ...
      <main className="connect-main connect-doc">
        ...
        <section className="connect-section">
          ...
          <ol className="connect-steps">
            <li>
              Open Home and choose <strong>Build an item type</strong>.
            </li>
            <li>
              Describe a publication, project board, notes system, or your own
              idea.
            </li>
            <li>
              Refine the result in conversation or adjust its visual direction,
              properties, and folder view.
            </li>
            <li>
              Inspect the Item and Folder previews with real, sample, empty, or
              stress-test content.
            </li>
            <li>
              Choose Done once. New items in that folder inherit the type.
            </li>
          </ol>
        </section>
        ...
        <section className="connect-section">
          <h2 className="connect-section-title">
            Refine without losing a direction
          </h2>
          ...
          <p className="connect-body">
            ...
            selected folder&apos;s existing items, built-in sample content, a
            blank state, or deliberately long stress-test content. Wide, tablet,
            and phone frames make narrow-layout problems visible before saving.
            A deterministic preflight names important structural issues and
        ...
        <section className="connect-section">
          ...
          <p className="connect-body">
            ...
            starters. They work immediately, remain fully editable, and need no
            provider connection. Prompt-based generation in the App Store and
            browser editions uses a workspace Anthropic or OpenAI provider key.
            The standalone Mac edition may instead use an eligible connected
            ChatGPT or Codex account.
          </p>
        </section>
        ...
        <section className="connect-section">
          ...
          <ul className="connect-feature-list">
            <li>
              “A Medium-like publication with headline, subtitle, hero image,
              author, and date.”
            </li>
            <li>
              “A calm Notion-like project board grouped by status, with priority
              and due dates.”
            </li>
            <li>
              “Fast Apple Notes-like notes with a title, body, tags, and
              modified date.”
            </li>
          </ul>
          <p className="connect-body">
        ...
        <section className="connect-section">
          <h2 className="connect-section-title">
            Model the information, not just the page
          </h2>
          <p className="connect-body">
            Item types can declare text, rich text, images, dates, URLs,
            selects, numbers, checkboxes, relations, people records, recurrence,
            and repeating rows. People are ordinary linked TextText records, not
            workspace accounts. Status fields can define allowed transitions,
            and recurrence uses safe named presets.
          </p>
          <p className="connect-body">
            ...
            while secondary properties can appear conditionally after a checkbox
            or single-select choice is set.
          </p>
        </section>

        <section className="connect-section">
          <h2 className="connect-section-title">
            Give one folder several useful views
          </h2>
          <p className="connect-body">
            ...
            fields, and renderer. The folder&apos;s View menu switches between
            the declared views without duplicating or rewriting any document.
          </p>
        </section>

        <section className="connect-section">
          <h2 className="connect-section-title">
            Keep and share the looks that work
          </h2>
          <p className="connect-body">
          ...
          <p className="connect-body">
            ...
            history remains available, and restoring an earlier design copies it
            forward as a new version instead of rewriting history. Documents
        ...
        <section className="connect-section">
          ...
          <p className="connect-body">
            The App Store and browser editions use a workspace provider key to
            design the preview inside the focused builder. The standalone Mac
            edition may instead use an eligible connected ChatGPT or Codex
            account. A bearer-authenticated hosted MCP agent can also create the
            same complete item type through TextText tools. Tell the agent the
