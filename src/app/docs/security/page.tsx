...
export default function SecurityPage() {
  return <div className="applecms connect-shell"><main className="connect-main connect-doc">
    ...
    <section className="connect-section"><h2 className="connect-section-title">Hosted MCP connection</h2><p className="connect-body">The client receives only the scopes and workspace access granted by the revocable token it was given. Requests are authenticated, audited, and checked against workspace visibility. Revoke a client from Connect.</p></section>
