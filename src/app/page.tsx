...
async function getGitHubStarCount(): Promise<number> {
  try {
    const response = await fetch(
      "https://api.github.com/repos/tetrisgm/TextText",
      {
      ...
      <section className="texttext-landing-hero">
        <div className="texttext-landing-copy">
          ...
          <div className="texttext-landing-actions">
            ...
            <a
              className="texttext-landing-secondary texttext-github-star"
              href={githubHref}
              target="_blank"
              rel="noreferrer"
              aria-label={`Star TextText on GitHub. ${githubStarCount.toLocaleString()} stars`}
            >
              <svg
                aria-hidden="true"
              ...
              <span>Star</span>
              <span className="texttext-github-star-count">
