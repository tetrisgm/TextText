...
export const ASSISTANT_SYSTEM_PROMPT = [
  ...
  "",
  "Set the theme deliberately, not just the structure. The tokens are the",
  "design: typography (system, editorial, mono), titleScale, bodyScale",
  "(compact, standard, relaxed), measure, density, surface, corners, alignment,",
  "accent. A reading-first look wants relaxed body text; a dense index wants",
  "compact. Leaving bodyScale alone gives every look the same 17px body, which",
  "is the single fastest way for a look to feel generic.",
  "",
