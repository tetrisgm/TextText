...
`src/lib/ai/tools.ts` is the source of truth for the 50 tool
...
| `sync` | Call all 50 tools, including the 35 that mutate content or read administration data. It also grants every `read` operation. |
<!-- /generated:scope-table -->
